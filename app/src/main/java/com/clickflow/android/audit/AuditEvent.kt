...
object AuditType {
   ...
   // ---- Step 62: single-real-tap prototype audit events ----
   const val REAL_TAP_REQUESTED = "realtap.requested"
   const val REAL_TAP_BLOCKED = "realtap.blocked"
   const val REAL_TAP_CONSENT_SHOWN = "realtap.consent.shown"
   const val REAL_TAP_CONSENT_GIVEN = "realtap.consent.given"
   const val REAL_TAP_CONSENT_DECLINED = "realtap.consent.declined"
   const val REAL_TAP_SAFETY_REVIEW_PASSED = "realtap.safetyReview.passed"
   const val REAL_TAP_SAFETY_REVIEW_FAILED = "realtap.safetyReview.failed"
   const val REAL_TAP_DISPATCH_ATTEMPTED = "realtap.dispatch.attempted"
   const val REAL_TAP_DISPATCH_SUCCEEDED = "realtap.dispatch.succeeded"
   const val REAL_TAP_DISPATCH_FAILED = "realtap.dispatch.failed"
   const val REAL_TAP_SESSION_STARTED = "realtap.session.started"
   const val REAL_TAP_SESSION_ENDED = "realtap.session.ended"
   const val REAL_TAP_PERMISSION_MISSING = "realtap.permission.missing"
   const val REAL_TAP_GESTURE_UNAVAILABLE = "realtap.gesture.unavailable"
}
