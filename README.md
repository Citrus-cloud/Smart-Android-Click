...
- the prototype screen is reachable from **Advanced → Прототип реального тапа** and routed via
`Screen.REAL_TAP_PROTOTYPE` in `Screens.kt`; `ClickFlowViewModel` exposes the six prototype APIs
